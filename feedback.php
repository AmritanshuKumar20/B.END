...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">amritanshu@gmail.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<!-- <div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Amritanshu Kumar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">7355223234</h4>
		<h4 style="font-family:'typo' ">amritanshu@gmail.com</h4>
		<h4 style="font-family:'typo' ">Lovely Professional University,Punjab</h4></div></div>
		</p>
      </div>
